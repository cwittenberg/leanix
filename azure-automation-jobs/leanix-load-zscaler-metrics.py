...
"""
You have to CREATE your own schemas first using leanix_api.create_schema procedure. Substitute GUIDs in below.
"""

METRIC_SCHEMA_USERS = {
    "name": "NumberOfUsers",
    "guid": "62a3fe63-55ae-496e-8197-503ae5dfc187"
}
METRIC_SCHEMA_DOWNLOAD = {
    "name": "dataDownload",
    "guid": "6527040a-e06a-4e09-92c7-9e3f1f54f6a2"
}
METRIC_SCHEMA_UPLOAD = {
    "name": "dataUpload",
    "guid": "605c0a8b-342f-473b-803a-14ed679eb1a4"
}
...
ZSCALER_DISCOVERY = "<zscaler discovery factsheet ID>"
